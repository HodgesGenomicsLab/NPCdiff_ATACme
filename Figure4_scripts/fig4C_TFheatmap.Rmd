...
TF_heatmap<- pheatmap(m_counts_symbol_sigLRT, scale = "row", cluster_cols = F, cutree_rows = 6, show_rownames = F, annotation_row = anno, main = "TF Expression Patterns", color = rev(c("#B2182B", "#D6604D", "#F4A582", "#FDDBC7", "#D1E5F0", "#92C5DE", "#4393C3", "#2166AC")))
