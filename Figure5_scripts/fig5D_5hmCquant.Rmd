...
hmC_boxplot<- ggplot()+
  ...
  theme_minimal()
hmC_boxplot
ggsave(hmC_boxplot, filename= "/Users/lindsey/Desktop/Hodges_Lab/ATAC-me\ NPCdiff/NPCDiff_ATACme/New_timepoints/Figures/bycluster_hmC_time_6L.pdf", units = "in", width = 4, height = 5)
